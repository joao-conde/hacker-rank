...
int* total_number_of_books; /* total number of books in each shelf */

/*
 * Total number of pages in each book of each shelf.
 * Rows represent the shelves and the columns represent the books.
 */
...
int main(){
    ...
    while (total_number_of_queries--) {
        ...
        if (type_of_query == 1) {
			...
			//re-allocation now memory for the extra book
